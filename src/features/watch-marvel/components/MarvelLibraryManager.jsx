...
export function MarvelLibraryManager({ titles, refresh, toast }) {
  ...
  return (
    <section className="wm-settings-section" id="library"><header><div><p className="section-kicker">01 · Catalogue</p><h2>Marvel Library</h2></div><button className="primary-button" type="button" onClick={() => setEditing(null)}><Plus aria-hidden="true" /> Add title</button></header>
