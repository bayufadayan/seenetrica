// Physical name retained for backward compatibility with existing devices.
export const PLAYER_DB_NAME = "seenetrica-watch-marvel";
export const PLAYER_DB_VERSION = 2;
...
export function createDefaultSettings() {
  ...
  return {
    ...structuredClone(DEFAULT_PLAYER_SETTINGS),
    createdAt: now,
    updatedAt: now,
  };
}
